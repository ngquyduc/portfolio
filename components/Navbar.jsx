    ...
    <div style={{backgroundColor: `${navBg}`}} className={shadow ? 'fixed w-full h-20 shadow-xl z-[100]' : 'fixed w-full h-20 z-[100]'}>
        ...
        <div className={nav ? 'md:hidden fixed left-0 top-0 w-full h-screen bg-black/70' : ''}>
            <div className={nav ? 'fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-[#ecf0f3] p-10 ease-in duration-500' : 'fixed left-[-100%] top-0 p-10 ease-in duration-500'}>
                <div>
                    <div className='flex w-full items-center justify-between ' onClick={() => setNav(false)}>
                        <Link href='/'>
                            <Image src='/../public/assets/navLogo.png' width='80' height='80' alt='/'/>
                            <div onClick={handleNav} lassName='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer'>
                            </div>
                        </Link>
                    </div>
                ...
                <div className='py-4 flex flex-col'>
                    ...
                    <div className='pt-40'>
                        <p className='uppsercase tracking-widest text-[#5651e5'>Let's Connect</p>
                        <div className='flex items-center justify-between my-4 w-full sm:w-[80%]'>
                            ...
                            <Link href='/#contact'>
                            <div className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300' onClick={() => setNav(false)}>
                                <AiOutlineMail/>
                            </div>
                        </Link>
                        <a
